        ...
        return (
            <tr className="order_card">
                ...
                <td className="product_info">
                    ...
                    <button className="quantity-product-btn" onClick={(e) => {this.updateProductQuantity('increase', this.props.product_id)}}><i className="cal-btn">+</i></button>
                    <button className="quantity-product-btn" onClick={(e) => {this.updateProductQuantity('decrease', this.props.product_id)}}><i className="cal-btn">-</i></button>
                </td>
                <td className="product_info">
